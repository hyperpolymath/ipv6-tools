...
// Replace ipv6-tools, Ipv6 Tools — See README.adoc for details., just run, Ipv6 Tools started successfully. with actuals
= ipv6-tools — Quick Start for Users
:toc:
:toclevels: 2

== What is ipv6-tools?

Ipv6 Tools — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./ipv6-tools-portable
----
...
[source]
----
Ipv6 Tools started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/ipv6-tools/wiki
